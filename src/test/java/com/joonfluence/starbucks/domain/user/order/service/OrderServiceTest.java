...
class OrderServiceTest {
    ...
    class Describe_createOrder {
        ...
        void 주문시_정상_주문_결제_처리되어야_한다() {
            // given
            when(productService.getProductById(Mockito.any(Long.class))).thenReturn(testProduct);
            when(customerService.getCustomer(Mockito.any(Long.class))).thenReturn(testCustomer);
        ...
        void 존재하지_않는_ProductId를_선택했을_때_생성되면_안된다(){
            // given
            when(productService.getProductById(Mockito.any(Long.class))).thenThrow(NoSuchProductException.class);
            when(customerService.getCustomer(Mockito.any(Long.class))).thenReturn(testCustomer);
        ...
        void 존재하지_않는_CustomerId를_선택했을_때_생성되면_안된다(){
            // given
            when(customerService.getCustomer(Mockito.any(Long.class))).thenThrow(NoSuchCustomerException.class);
